                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>  
                                                ...
                                                <td>
                                                    <a class="btn btn-info" href="reviewupdate.php?id=<?php echo $row["reId"];?>">Update</a>
                                                    <a class="btn btn-danger" onclick="return confirm('Are you sure to delete this item?')" href="reviewdelete.php?id=<?php echo $row["reId"];?>">Delete</a> 
                                                </td>
                                            </tr>
                                        <?php }}   ?>
                                    </tbody>
