            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 d-flex justify-content-center">Add Educational Information</h1>
                        <div class="col-md-12">
                            <div class="form">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-field">                                         
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                    <input type="text" name="rHead"  class="form-control" placeholder="Head">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="rTitle" class="col-sm-2 col-form-label">Title</label>
                                                    <div class="col-sm-10">
                                                    <input type="text" name="rTitle"  class="form-control" placeholder="Title">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                    <textarea type="text" name="rdetails" class="form-control" placeholder="Educational Details" rows="3"></textarea>
                                                    </div>
                                                </div>
                                                <div class="d-grid">
