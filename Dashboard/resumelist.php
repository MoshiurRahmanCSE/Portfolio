            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 d-flex justify-content-center">Educational Information Details</h1>
                        <div class="col-md-12">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>  
                                                ...
                                                <td>
                                                    <a class="btn btn-info" href="resumeupdate.php?id=<?php echo $row["rId"];?>">Update</a>
                                                    <a class="btn btn-danger" onclick="return confirm('Are you sure to delete this item?')" href="resumedelete.php?id=<?php echo $row["rId"];?>">Delete</a> 
                                                </td>
                                            </tr>
                                        <?php }}   ?>
                                    </tbody>
