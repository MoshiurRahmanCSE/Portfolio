<?php 
    ...
    $sqlCat = "SELECT  cId, cName FROM categorydb WHERE status = 1";
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 d-flex justify-content-center">Project Information</h1>
                        <div class="col-md-12">
                            <div class="form">
                                    ...
                                    <div class="row">                                   
                                        <div class="col-md-12">
                                            <div class="input-field">
                                                <div class="mb-3 row">
                                                    <label for="categoryid" class="col-sm-2 col-form-label"> List of Category</label>
                                                    <div class="col-sm-4">
                                                        <select class="form-select" name="categoryid" required>
                                                            <?php
                                                                $sql = "SELECT cId, cName FROM categorydb WHERE status=1";
                                                                $result = mysqli_query($conn, $sql);
                                                                while($row = mysqli_fetch_assoc($result)){
                                                                    ?>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                    <input type="text" name="projectURL"  class="form-control"  placeholder="www.example.com">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="projectDate" class="col-sm-2 col-form-label">Project Date</label>
                                                    <div class="col-sm-10">
                                                    <input type="date" name="projectDate"  class="form-control" placeholder="Project Date">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="shortDesc" class="col-sm-2 col-form-label">Short Description</label>
                                                    <div class="col-sm-10">
                                                    <textarea type="text" name="shortDesc" class="form-control" placeholder="Write short Description" rows="3"></textarea>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="decription" class="col-sm-2 col-form-label">Description</label>
                                                    <div class="col-sm-10">
                                                    <textarea type="text" name="decription" class="form-control" placeholder="Write Description" rows="4"></textarea>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
