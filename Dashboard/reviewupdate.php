            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 d-flex justify-content-center">Review/ Testimonial Information Update</h1>
                        <div class="col-md-12">
                            <div class="form">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-field">                                       
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                    <input type="text" name="reNameBn"  class="form-control" placeholder="Name" value="<?php echo $row["reNameBn"];?>">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="reDesignation" class="col-sm-2 col-form-label">Designation</label>
                                                    <div class="col-sm-10">
                                                    <input type="text" name="reDesignation"  class="form-control" placeholder="Designation" value="<?php echo $row["reDesignation"];?>">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="reComment" class="col-sm-2 col-form-label">Comments</label>
                                                    <div class="col-sm-10">
                                                    <textarea type="text" name="reComment" class="form-control" placeholder="Comments" rows="3"><?php echo $row["reComment"];?></textarea>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
